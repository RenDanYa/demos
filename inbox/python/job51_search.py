...
用法:
    python job51_search.py                          # 弹窗输入关键词 + 城市 + 数量
    python job51_search.py "外贸"                    # 默认宁波, 采集 20 个
    python job51_search.py "外贸" 上海               # 指定城市
    python job51_search.py "外贸" 上海 30            # 指定城市 + 数量
    python job51_search.py "外贸" 上海 30 5          # 断点续传: 从第 5 个开始获取详情
"""
...
# ============ 配置 ============
OUTPUT_ROOT = OBSIDIAN_ROOT / "05_long_project" / "前程无忧"
...
def search_jobs(query, city, limit):
    ...
    log(f"调用 opencli job51 search (城市={city}, limit={limit})")
