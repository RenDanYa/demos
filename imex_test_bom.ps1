...
$cs = 'Provider=Microsoft.ACE.OLEDB.12.0;User ID=Admin;Data Source=D:\obsidian\demo\Excel面试实操题库.xlsx;Mode=Share Deny Write;Extended Properties="Excel 12.0 Xml;HDR=YES;IMEX=1"'
